...
const THEME_PRESET_OVERRIDES = {
  [THEME_PRESET_IDS.VINTAGE_WORKSHOP]: {
  ...
  [THEME_PRESET_IDS.STAGE_BLACK]: {
    appBackgroundColor: "#0e1013",
    appBackgroundAccentColor: "#1f1b18",
    appGlowColor: "#87673e",
    appTextColor: "#f5eee3",
    uiFontFamily: 'Optima, "Segoe UI", sans-serif',
    surfaceColor: "#171a1f",
    surfaceStrongColor: "#1e2228",
    borderColor: "#383129",
    mutedTextColor: "#b7a693",
    accentColor: "#c7964c",
    accentStrongColor: "#edc67d",
    accentTextColor: "#15110c",
    drawerBackgroundStartColor: "#1b1f25",
    drawerBackgroundEndColor: "#101318",
    drawerBorderColor: "#40362b",
    ...
    stringLabelColor: "#f0d4a5",
    stringLineColor: "#c59e61",
    fretLineColor: "#8b734d",
    fretNumberColor: "#ecd1a2",
    openFretLabelColor: "#ecd1a2",
    markerColor: "#c59d63",
    markerOpacity: 0.28,
    noteFillColor: "#d8af70",
    noteTextColor: "#17110a",
    fretboardPanelColor: "#111316",
  },
...
export const THEME_PRESETS = [
  ...
  },
  {
    ...
    label: "Stage Black",
    description: "Low-glare charcoal UI built for rehearsal rooms and dim stages.",
    vibe: "Focused and premium",
    preview: {
      chip: "#c7964c",
      chipText: "#15110c",
      panel: "#111316",
...
export const DEFAULT_FRETBOARD_VISUAL_SETTINGS = {
  ...
  appBackgroundColor: "#f4ebde",
  appBackgroundAccentColor: "#d8c2a4",
  appGlowColor: "#d9a973",
  appTextColor: "#402d22",
  uiFontFamily: '"Trebuchet MS", "Segoe UI", sans-serif',
  surfaceColor: "#fbf8f4",
  surfaceStrongColor: "#fffaf6",
  borderColor: "#d8cec4",
  mutedTextColor: "#7a6658",
  accentColor: "#5b3824",
  accentStrongColor: "#734a33",
  accentTextColor: "#f8dfc3",
  drawerBackgroundStartColor: "#fcf6ef",
  drawerBackgroundEndColor: "#f4eadf",
  drawerBorderColor: "#d9cbc0",
  ...
  stringLabelColor: "#f5d2ab",
  stringLabelFontSize: 12,
  stringLineColor: "#d8bb96",
  fretLineColor: "#8b684e",
  fretNumberColor: "#f0cfaa",
  fretNumberFontSize: 11,
  openFretLabelColor: "#f0cfaa",
  openFretLabelSize: 11,
  markerColor: "#6f4a35",
  markerOpacity: 0.32,
  noteFillColor: "#f3d1a7",
  shortNoteRadius: 10,
  longNoteRadius: 13,
  noteTextColor: "#4a2f20",
  shortNoteFontSize: 10.5,
  longNoteFontSize: 9.5,
  fretboardPanelColor: "#5b3824",
};
